...
class ConanProduct(ConanFile):
    ...
    def build(self):
        ...
        cmake.configure(defs={"FEP_CYCLONE_DDS_VERSION": self.version, 
                            #   "CycloneDDS-CXX_DIR": self.deps_cpp_info["cyclonedds-cxx"].rootpath + "/lib/cmake/CycloneDDS-CXX",
                            # "CycloneDDS_DIR": self.deps_cpp_info["cyclonedds"].rootpath + "/lib/cmake/CycloneDDS"
